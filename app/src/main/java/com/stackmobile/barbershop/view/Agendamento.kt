...
class Agendamento : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.timePicker.setIs24HourView(true) //formatode 24 horas
        ...
        binding.btAgendar.setOnClickListener {
            ...
            when {
                ...
                hora < "8:00" && hora > "19:00" -> {
                    mensagem(
                        it,
                        "BarberMan está fechado - horário de atendimento das 08:00 às 19:00!!! ",
                        "#FF0000"
                    )
                }
                ...
                barbeiro1.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Cesar Figueiredo", data, hora)

                }

                barbeiro2.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Willians Camaioni", data, hora)

                }

                barbeiro3.isChecked && data.isNotEmpty() && hora.isNotEmpty() -> {
                    salvarAgendamento(it, nome, "Ronny Sousa", data, hora)
    ...
    private fun salvarAgendamento(
        ...
        val telaConsultar = Intent(this,Consultar::class.java)
